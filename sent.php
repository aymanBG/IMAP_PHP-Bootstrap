...
<body>
    <div id="wrapper">
        ...
        <div id="" class="gray-bg dashbard-1">
            ...
            <?php
        $mbox = imap_open("{imap.gmail.com:993/imap/ssl/novalidate-cert}[Gmail]/Messages envoy&AOk-s", "p.aumaric@phenixassurances.fr", "JH178cwse")
...
window.location = "sent.php?lp="+clicked_id;
}
</script>

<script>
function reclick(clicked_id) {
window.location = "sent.php?plp="+clicked_id;
}
</script>
<script>
              function reply_click(clicked_id) {
                window.location = "maile_detail.php?id=" + clicked_id;
              }
            </script>
                                ...
                                <tbody>
                                  ...
                                  <?php foreach ($result as $overview) : ?>
                                    <tr class="unread" id="<?php echo imap_utf8($overview->uid); ?>" onClick="reply_click(this.id)">
                                        ...
                                        <td class="mail-ontact"><?php echo $overview->to; ?></a>
                                        </td>
